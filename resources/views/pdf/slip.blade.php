            ...
            <thead>
                <tr style="text-align:left;">
                    <th style="vertical-align:top; padding:15px 0; border-bottom:5px solid #ccc;">
                        <div style="font-size:0.8rem; font-weight:600; margin-bottom:4px; color: #77787b;"> items
                        </div>
                    </th>

                    <th style="vertical-align:top; padding:15px 0; border-bottom:5px solid #ccc;">
                        <div style="font-size:0.8rem; font-weight:600; margin-bottom:4px; color: #77787b;"> Product
                        </div>
                    </th>

                    <th style="vertical-align:top; padding:15px 0; border-bottom:5px solid #ccc;">
                        <div style="font-size:0.8rem; font-weight:600; margin-bottom:4px; color: #77787b;"> Height
                        </div>
                        <div style="font-size:0.8rem; font-weight:600; margin-bottom:4px; color: #77787b;"> Hauteur
                        </div>
                    </th>

                    <th style="vertical-align:top; padding:15px 0; border-bottom:5px solid #ccc;">
                        <div style="font-size:0.8rem; font-weight:600; margin-bottom:4px; color: #77787b;">Depth
                        </div>
                        <div style="font-size:0.8rem; font-weight:600; margin-bottom:4px; color: #77787b;"> Profoundeur
                        </div>
                    </th>

                    <th style="vertical-align:top; padding:15px 0; border-bottom:5px solid #ccc;">
                        <div style="font-size:0.8rem; font-weight:600; margin-bottom:4px; color: #77787b;">Width
                        </div>
                        <div style="font-size:0.8rem; font-weight:600; margin-bottom:4px; color: #77787b;"> Largeur
                        </div>
                    </th>

                    <th style="vertical-align:top; padding:15px 0; border-bottom:5px solid #ccc;">
                        <div style="font-size:0.8rem; font-weight:600; margin-bottom:4px; color: #77787b;"> Qty
                        </div>
                    </th>
            ...
            <tbody>
                ...
                @foreach ($items as $item)
                    ...
                    <tr>
                        ...
                        <td style="vertical-align:top; padding:25px 0; ">

                            <div style="font-size:0.8rem; margin-bottom:4px; color: #77787b;"> {{ $item['id'] }}
                            </div>
                        </td>
                        <td style="vertical-align:top; padding:25px 0; ">
                        ...
                        <td style="vertical-align:top; padding:25px 0; ">
                            ...
                            <div style="font-size:0.8rem; margin-bottom:4px; color: #77787b;"> {{ $item['height'] }}
                            </div>
                        </td>

                        <td style="vertical-align:top; padding:25px 0; ">

                            <div style="font-size:0.8rem; margin-bottom:4px; color: #77787b;"> {{ $item['depth'] }}
                            </div>
                        </td>

                        <td style="vertical-align:top; padding:25px 0; ">

                            <div style="font-size:0.8rem; margin-bottom:4px; color: #77787b;"> {{ $item['width'] }}
                            </div>
                        </td>
                        ...
                        <td style="vertical-align:top; padding:25px 0; ">
                            ...
                            <div style="font-size:0.8rem; margin-bottom:4px; color: #77787b;"> {{ $item['quantity'] }}
                            </div>
                        </td>
        ...
        <table cellspacing="0" style="width:100%">
            ...
            <tbody>
                <tr>
                    ...
                    <td style="vertical-align:top; padding:25px 0; width: 50%; border-top:5px solid #ccc;">
                        ...
                        <div style="font-size:0.8rem; font-weight:600; margin-bottom:4px; color: #77787b;">
                            Total Cubic Measurements(10lbs/p3): {{ $billingDetails['total_cubic_measurement'] }}
                    ...
                    <td style="vertical-align:top; padding:25px 0; border-top:5px solid #ccc; width: 25%;">
                        <div
                            style="font-size:0.8rem; font-weight:600; margin-bottom:4px; color: #77787b; margin-left: 16rem;">
                            Total Items:
                ...
                <tr>
                    ...
                    <td style="vertical-align:top; padding:25px 0; width: 50%; ">
                        <div style="font-size:0.8rem; font-weight:600; margin-bottom:4px; color: #77787b;"> Checked By:
                        </div>
                    </td>



                    <td style="vertical-align:top; padding:25px 0; width: 25%;">
                        <div
                            style="font-size:0.8rem; font-weight:600; margin-bottom:4px; margin-left:16rem; color: #77787b;">
                            Date:
                        </div>
                    </td>
                ...
                <tr>
                    ...
                    <td style="vertical-align:top; padding:25px 0; width: 50%; ">
                        <div>
                            <img src="{{ url('https://dummyimage.com/200x200.jpg?text=Test') }}" alt="logo"
                    ...
                    <td style="vertical-align:top; padding:25px 0; width: 50%; ">
                        <div style="font-size:0.8rem; font-weight:600; margin-bottom:4px; color: #77787b;"> Any and all
                            discrepancies must be reported and acknowledged by Belmont Doors within 15 Business Days of
                            Delivery Date.
                        </div>
                    </td>
